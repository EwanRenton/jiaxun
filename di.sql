...
-- 数据库: `di`
--
CREATE DATABASE IF NOT EXISTS `di` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `di`;
...
(11, '产品列表', 2, '/index.php/Admin/Product/index'),
(12, '添加产品', 2, '/index.php/Admin/Product/add'),
(13, '产品分类', 2, '/index.php/Admin/Product/sort'),
(14, '会员列表', 3, '/index.php/Admin/Member/index'),
(15, '添加会员', 3, '/index.php/Admin/Member/add'),
(16, '第三方账号', 3, ''),
(17, '留言管理', 4, '/index.php/Admin/Message/index'),
(18, '评价管理', 4, ''),
(19, 'banner管理', 5, '/index.php/Admin/Photo/index'),
(20, '广告位管理', 5, ''),
(21, '图片链接', 6, '/index.php/Admin/Link/img_link'),
(22, '文字链接', 6, '/index.php/Admin/Link/words_link'),
(23, '基础设置', 7, ' '),
