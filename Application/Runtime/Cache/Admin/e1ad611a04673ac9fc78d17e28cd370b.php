...
<div class="rightfix">
  	<a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_pass">营销活动</a><a class="home_now">留言管理</a>
  	<div class="clear"></div>
  	<table CellSpacing=0>
 		...
 		<?php if(is_array($msg)): foreach($msg as $key=>$val): ?><tr>
	  			...
	  			<td class="tab5"><a href="<?php echo U('/index.php/Admin/Message/delete',array('msg_id'=>$val['msg_id']));?>" class="delete">删除</a> / <a class="see">查看</a><a class="close" style="display:none">关闭</a></td>
	  		</tr>
	  		<tr>
...
$('.close').click(function(){
	...
	var url = '/index.php/Admin/Message/index/limit/'+page_num;
