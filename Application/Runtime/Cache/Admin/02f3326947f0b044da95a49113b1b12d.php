...
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">友情链接</a><a class="home_now">文字连接</a><a href="/index.php/Admin/Link/words_add" class="home_right">添加文字链接</a>
  <div class="clear"></div>
  <div class="article_list">
    ...
    <?php if(is_array($w_link)): foreach($w_link as $key=>$val): ?><div class="table_list">
        <div class="wz_list">
          ...
          <div class="wz_table2"><a class="aa1" href="<?php echo U('/index.php/Admin/Link/words_del',array('wid'=>$val['wl_id']));?>">删除</a></div>
        </div>
      </div>
...
if(adm_power.indexOf('文字链接') === -1){
  ...
  $('.wl_name').blur(function(){
    ...
    $.post('/index.php/Admin/Link/change_name',{'wl_name':wl_name,'id':id},function(data){
      if(data){
        return true;
      }
    },'json');
  ...
  $('.wl_gourl').blur(function(){
    ...
    var id = $(this).attr('wlid');
    $.post('/index.php/Admin/Link/change_gourl',{'wl_gourl':wl_gourl,'id':id},function(data){
      if(data){
        return true;
      }
    },'json');
  ...
  $('.wl_order').blur(function(){
    ...
    var id = $(this).attr('wlid');
    $.post('/index.php/Admin/Link/change_order',{'wl_order':wl_order,'id':id},function(data){
      if(data){
        return true;
      }
    },'json');
  ...
  $('#check_').change(function(){
    var bp_id = $(this).val();
    var url = '/index.php/Admin/Link/words_link/bp/'+bp_id;
