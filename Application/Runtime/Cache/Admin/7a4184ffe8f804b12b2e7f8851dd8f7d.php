...
<div class="rightfix">
    <a href="<?php echo U('/index.php/Admin/Index/index');?>" class="home1"></a><a class="home_pass">文章管理</a><a class="home_now">文章列表</a>
    <div class="clear"></div>
