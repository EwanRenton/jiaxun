...
<!--文章添加-->
<div class="rightfix">
  <a class="home1"></a><a class="home_pass">产品管理</a><a href="<?php echo U('/index.php/Admin/Product/index');?>" class="home_pass">产品列表</a><a class="home_now">产品分类</a>
  <div class="clear"></div>
