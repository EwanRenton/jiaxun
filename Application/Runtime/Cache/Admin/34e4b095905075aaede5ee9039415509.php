      ...
      <table>
        ...
        <?php if(is_array($news)): foreach($news as $key=>$value): ?><tr class="table_list">
          ...
          <?php if($value['pro_isshow'] == 1): ?><a class="aa1" href="javascript:;" isshow="1" artID="<?php echo ($value["pro_id"]); ?>" style="display:inline">隐藏</a><a href="javascript:;" class="aa4" isshow="0" artID="<?php echo ($value["pro_id"]); ?>" style="display:none" >显示</a>
              <?php else: ?><a class="aa1" href="javascript:;" isshow="0" artID="<?php echo ($value["pro_id"]); ?>" style="display:none">隐藏</a><a href="javascript:;" class="aa4" isshow="0" artID="<?php echo ($value["pro_id"]); ?>" style="display:inline" >显示</a><?php endif; ?> /  <a href="<?php echo U('/index.php/Admin/Product/editor',array('aid'=>$value['pro_id']));?>" class="aa2">编辑</a> /  <a href="<?php echo U('/index.php/Admin/Product/delete',array('aid'=>$value['pro_id']));?>" class="aa3">删除</a>/<a class="pinglun" href="<?php echo U('/index.php/Admin/Product/comment',array('pid'=>$value['pro_id']));?>"><?php if($value['mentNum']){echo "评论(".$value['mentNum'].")";}else{echo "评论(0)";} ?></a></td>
