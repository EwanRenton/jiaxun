            ...
            <tr>
                <td colspan="5" class="tab6">
                    <div class="off">
                        ...
                        <h3>回复留言：</h3><span><form action="<?php echo U('/index.php/Admin/Message/addReplyMessage',array('reply_cmtid'=>$val['msg_id']));?>" method="post"><textarea name="reply_content" id="reply_content" cols="30" rows="4"></textarea>
